"""
Django settings for AcademyTop project.
...
INSTALLED_APPS = [
    ...
    # 3‑party пакеты, которые уже в requirements.txt
    "crispy_forms",
    "crispy_bootstrap5",
    "rest_framework",
    "core",
...
WSGI_APPLICATION = 'AcademyTop.wsgi.application'
